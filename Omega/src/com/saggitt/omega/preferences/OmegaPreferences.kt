...
class OmegaPreferences(val context: Context) : BasePreferences(context) {
    ...
    var hiddenAppSet by StringSetConfigPref(PREFS_HIDDEN_SET, setOf(), reloadApps)
    var hiddenPackageSet by StringSetConfigPref("hiddenPackageSet", setOf())
    var reverseHidden by BooleanConfigPref("reverseHidden", false, reloadApps)
    var exitHidden by BooleanConfigPref("exitHidden", false, reloadApps)
    var passwordHidden by StringConfigPref("passwordHidden")
